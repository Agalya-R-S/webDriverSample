...
public class CreateUpdateBooking 
{
  ...
  public void createNewBooking()
  {
	  ...
	  Assert.assertEquals(fname, "Agalya");  	  
  }
  ...
  public void updateBooking()
  {
	  ...
	  System.out.println("Token value to update booking:"+strToken);
	...
	//Assert.assertEquals(fname, "Agalya");
	  ...
	  System.out.println(delResp.statusLine());
